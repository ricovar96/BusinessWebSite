...
export class SearchComponent  {
  ...
  Groups=[
    ...
    {Name : "How-To", 
    Links: [ 
      { title: 'Reach me out', description: 'You can send me a message through Likendin Chat', sourceLink: 'https://www.linkedin.com/in/fabian-daniel-rico-vargas-89731a107/' },
